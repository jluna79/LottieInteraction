# A sandbox to test LottieXamarin

This is a fork from [LottieXamarin](https://github.com/martijn00/LottieXamarin) to try out Lottie for XamarinForms. 

The main objective is to try out how interaction using animations work on Froms. 

Currently not working for me using a `GestureRecognizer` nor using a [CustomRenderer](http://arteksoftware.com/gesture-recognizers-with-xamarin-forms/). 

Be sure to try out the [LottieFiles Editor](https://editor.lottiefiles.com).
